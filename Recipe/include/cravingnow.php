<?php  
	...
	$sql="select * from recipe where sub_category_id=4";
	$result=$conn->query($sql);		
?>
<a href="#"><h2 style="font-size:16px; color:white; margin-top: 0; margin-left:0;" >WHAT WE'RE CRAVING NOW
</h2></a>
		<table border="2" width="80%" style="margin-left: 80px; margin-right: 80px;" >
			<tr>
				<?php 
					$count=1;
