...
<body>
	...
	<div class="recipe" style="margin-top: 50px; background-color:white;" width="80%;">

			<!-------- select all from recipe-------------->
			<?php
				$sql="select * from recipe where sub_category_id=3";
						...
						while($row=mysqli_fetch_assoc($result)){
							...
							echo '<td style="padding:10px; border-radius: 25px; border:1px solid gray; " valign="top" width="20%" align="center"  >
										<a href="detail.php?recipe_id='.$row['recipe_id'].'" style="color:black;">
											<img src="'.$row['recipe_image'].'" width="80%" height="200"> 
											<br>
											'.$row['recipe_name'].'
										</a>
								</td>';
